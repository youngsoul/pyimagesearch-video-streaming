...
This repo has code from the [PyImageSearch Blog](https://www.pyimagesearch.com/2019/04/15/live-video-streaming-over-network-with-opencv-and-imagezmq/)

## Setup

The setup can and likely will take a long time.
...
Beyond that follow the instructions in the PyImageSearch blog.
...
* I changed the ImageZMQ ImageSend class to take a send and receive timeout value so the client.py could handle these exceptions and re-establish the connection.  You can find my fork of the ImageZMQ [here](https://github.com/youngsoul/imagezmq)
